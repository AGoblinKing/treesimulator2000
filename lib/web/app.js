...
(function() {
  ...
  $(function() {
    var ASPECT, FAR, HEIGHT, NEAR, VIEW_ANGLE, WIDTH, camera, clock, controls, entities, light, render, renderer, scene, socket;
        ...
        switch (entity.type) {
          case "fog":
            if (entities[entity.properties.id]) {
              ...
              _results.push(entities[entity.properties.id] = void 0);
            } else {

  ...
  Player = (function(_super) {
    ...
    Player.prototype.setSocket = function(socket) {
      ...
      this.socket.on("update", function(_arg) {
        ...
        y = Math.floor(y);
        z = Math.floor(z);
        if (_this.x !== x || _this.y !== y || _this.z !== y) {
    ...
    Player.prototype.events = {
      "change:view": function(_arg) {
        var entity, name, oldValue, type, update, value;
        entity = _arg.entity, name = _arg.name, value = _arg.value, oldValue = _arg.oldValue, type = _arg.type;
        switch (type) {
          case "fog":
            if (entity) {
